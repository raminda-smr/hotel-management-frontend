        ...
        <div className="gallery-item">
            ...
            {isModalOpen && (
                <div className="image-modal fixed w-full h-full top-0 left-0 z-30 flex items-center justify-center bg-black/80" onClick={closeModal}>
                    <div className="back-drop relative max-w-3xl w-full p-4" onClick={(e) => e.stopPropagation()}>
                        <button onClick={closeModal} className="absolute top-0 right-0 p-2 text-white text-xl bg-red-500 rounded-full hover:bg-red-600 ">
                            <AiOutlineClose />
                        </button>
